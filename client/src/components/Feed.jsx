...
export const Feed = ({ onOpenCreatePost, onOpenProfile, onOpenAuth }) => {
  const { user } = useAuth();
  ...
  useEffect(() => {
    fetchPosts();
  }, [filter, selectedGenre, user]);

  const handleTagClick = (tag) => {
    // Strip hashtag and filter
  ...
  return (
    <div className="space-y-6 pb-28">
      ...
      <div className="glass-panel rounded-3xl p-5 sm:p-7 border border-white/10 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="space-y-1">
            ...
            <p className="text-xs sm:text-sm text-slate-300">
              Share track reviews, favorite lyric lines, and vibe ratings with the community.
            </p>
          </div>
