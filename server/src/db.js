  ...
  users: [
    {
      id: 'user-1',
      username: 'ariachen',
      email: 'aria@soundvibe.io',
      name: 'Aria Chen',
      avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80',
      bio: 'Crate digger & vinyl collector 🎧 Obsessed with 90s shoegaze, dream pop, and midnight electronic beats.',
      passwordHash: bcrypt.hashSync('musiclover123', 10),
      favoriteGenres: ['Dream Pop', 'Shoegaze', 'Indie Rock', 'Electronic', 'Lofi'],
      topTracks: [
        {
          id: 't-101',
      ...
      badges: ['Crate Digger', 'Top Curator', 'Dream Pop Pioneer'],
    ...
    },
    {
      ...
      email: 'marcus@soundvibe.io',
      name: 'Marcus Vance',
      avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80',
      bio: 'Beatmaker & sample hunter 🎹 R&B harmonics, boom bap drums, and futuristic Neo-Soul.',
      passwordHash: bcrypt.hashSync('musiclover123', 10),
      favoriteGenres: ['Hip-Hop', 'Neo-Soul', 'R&B', 'Jazz Fusion', 'Funk'],
      topTracks: [
        {
          id: 't-105',
          title: 'Pink + White',
        ...
        },
        {
          ...
          artwork: 'https://is1-ssl.mzstatic.com/image/thumb/Music115/v4/a1/38/c2/a138c20b-2268-d0df-7fa0-dfdfcbf65e2a/15UMGIM10183.rgb.jpg/600x600bb.jpg',
          previewUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview115/v4/44/24/ce/4424ce12-1f48-a006-2591-62863c0a2a4b/mzaf_17208151475727409278.plus.aac.p.m4a'
        }
      ],
      badges: ['Soul Connoisseur', 'Sample Master'],
    ...
    },
    {
      ...
      email: 'elena@soundvibe.io',
      name: 'Elena Rostova',
      avatar: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=150&auto=format&fit=crop&q=80',
      bio: 'Synth addict & cyberpunk aesthetician 🌆 Neon analog synths, darkwave basslines, and French touch house.',
      passwordHash: bcrypt.hashSync('musiclover123', 10),
      favoriteGenres: ['Synthwave', 'French House', 'Darkwave', 'Electronic', 'Nu-Disco'],
      topTracks: [
        {
          id: 't-107',
      ...
      badges: ['Synth Wizard', 'Neon Rider'],
      following: ['user-1'],
    ...
    },
    {
      id: 'user-4',
      username: 'devonmiles',
      email: 'devon@soundvibe.io',
      name: 'Devon Miles',
      avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80',
      bio: 'Fuzz pedals, vintage tubes, and psychedelic blues 🎸 If it has great basslines, I am in.',
      passwordHash: bcrypt.hashSync('musiclover123', 10),
      favoriteGenres: ['Psychedelic Rock', 'Indie Rock', 'Blues', 'Post-Punk', 'Alt-Rock'],
      topTracks: [
        {
          id: 't-109',
      ...
      badges: ['Riff Master', 'Guitar Fanatic'],
    ...
    {
      id: 'user-5',
      username: 'soratakahashi',
      email: 'sora@soundvibe.io',
      name: 'Sora Takahashi',
      avatar: 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=150&auto=format&fit=crop&q=80',
      bio: 'City Pop enthusiast & Japanese indie lover 🌸 Rainy day lofi melodies and nostalgic 80s Tokyo grooves.',
      passwordHash: bcrypt.hashSync('musiclover123', 10),
      favoriteGenres: ['City Pop', 'Lofi', 'J-Pop', 'Math Rock', 'Ambient'],
      topTracks: [
        {
          id: 't-110',
          title: 'Plastic Love',
      ...
      badges: ['City Pop Archivist', 'Chill Curator'],
  ...
  posts: [
    {
      ...
      rating: 5,
      headline: 'The bassline that redefined modern psychedelic pop forever',
      review: 'Almost a decade later and that opening bass groove still gives chills. Kevin Parker layered the flanger and bass guitar so perfectly that you cannot listen to this track just once. It strikes that rare sweet spot between danceable euphoria and melancholy nostalgia.',
      favoriteLyric: 'Someone said they left together, I ran out the door to get her...',
      vibeTags: ['#MidnightDrive', '#BasslineHeaven', '#Nostalgia', '#HeavyRotation'],
      mood: 'Euphoric / Melancholy',
      reactions: {
        fire: ['user-2', 'user-3', 'user-4'],
        vibe: ['user-1', 'user-2', 'user-5'],
        heart: ['user-3', 'user-5'],
        repeat: ['user-1', 'user-4', 'user-5'],
        mindblown: ['user-2'],
        overrated: []
      },
    ...
    },
    {
      ...
      rating: 5,
      headline: 'Pharrell & Frank Ocean created pure golden hour in audio form',
      review: 'The chord progression here combined with the subtle strings and Beyonce’s hidden background harmonies in the outro is sublime. Whenever I need to reset my mind after a long day, this is track #1 in the queue.',
      favoriteLyric: 'That is the way everyday goes, every time we have no control...',
      vibeTags: ['#GoldenHour', '#SoulHealing', '#Masterpiece', '#SundayMorning'],
      mood: 'Peaceful / Reflective',
      reactions: {
        fire: ['user-1', 'user-3'],
        vibe: ['user-1', 'user-3', 'user-4', 'user-5'],
        heart: ['user-1', 'user-2', 'user-4', 'user-5'],
        repeat: ['user-2', 'user-5'],
        mindblown: ['user-4'],
        overrated: []
      },
    ...
    },
    {
      ...
      rating: 5,
      headline: 'Vocoder synth magic meets The Strokes vocal swagger',
      review: 'The synthesis between Julian Casablancas’ distinctive melodic cadence and Daft Punk’s vintage analog outboard gear is sheer perfection. That key change into the guitar solo at 3:10 still gives me goosebumps every single time.',
      favoriteLyric: 'And we will never be alone again, cause it doesn’t happen everyday...',
      vibeTags: ['#Synthwave', '#Cyberpunk', '#HeartbreakAnthem', '#OnRepeat'],
      mood: 'Energetic / Melancholy',
      reactions: {
        fire: ['user-1', 'user-2', 'user-4'],
        vibe: ['user-1', 'user-4', 'user-5'],
        heart: ['user-1', 'user-3'],
        repeat: ['user-1', 'user-3', 'user-4'],
        mindblown: ['user-5'],
        overrated: []
      },
      createdAt: '2026-08-30T21:40:00.000Z'
    },
    {
      id: 'post-4',
      userId: 'user-5',
      ...
      rating: 4.8,
      headline: 'The undisputed queen anthem of 1980s Tokyo City Pop',
      review: 'Tatsuro Yamashita’s production on this arrangement is legendary. The rhythm section is tight as a clock, brass section punches right on cue, and Mariya’s vocal delivery encapsulates that bittersweet late-night city heartbreak.',
      favoriteLyric: 'I am just playing games, I know that’s plastic love...',
      vibeTags: ['#CityPop', '#TokyoNights', '#RetroVibes', '#HiddenGem'],
      mood: 'Nostalgic / Groovy',
      reactions: {
        fire: ['user-1', 'user-3'],
        vibe: ['user-1', 'user-2', 'user-3', 'user-4'],
        heart: ['user-1', 'user-5'],
        repeat: ['user-3', 'user-5'],
        mindblown: ['user-2'],
        overrated: []
      },
      createdAt: '2026-08-30T22:10:00.000Z'
    }
  ],
  comments: [
    {
      ...
      postId: 'post-1',
      userId: 'user-2',
      text: 'Hard agree on the bass tone! Kevin Parker ran a Rickenbacker 4001 through a boss pitch shifter and blues driver to get that synth-like thickness. Pure genius.',
      likes: ['user-1', 'user-4'],
    ...
    },
    {
      ...
      postId: 'post-1',
      userId: 'user-3',
      text: 'Still in my top 5 most played songs every single year on Spotify. Never gets old.',
      likes: ['user-1'],
    ...
    },
    {
      ...
      postId: 'post-2',
      userId: 'user-1',
      text: 'That background vocal from Beyonce at the end was so subtle that it took me 2 years to realize it was actually her haha! Truly timeless album.',
      likes: ['user-2', 'user-5'],
